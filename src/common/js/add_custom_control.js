    ...
    command.onAdd = function() {
        ...
        div.innerHTML = 
            ...
            "Select Job Sectors:<br /><select multiple size='20' id='jobsectors'>" +
                ...
                "<option value='23' title='Establishments primarily engaged in the construction of buildings or engineering projects'>Construction</option>" +
                "<option value='31-33' title='Establishments engaged in the mechanical, physical, or chemical transformation of materials, substances, or components into new products'>Manufacturing</option>" +
                "<option value='42' title='Establishments engaged in wholesaling merchandise, generally without transformation, and rendering services incidental to the sale of merchandise'>Wholesale Trade</option>" +
                "<option value='44-45' title='Establishments engaged in retailing merchandise and rendering services incidental to the sale of merchandise'>Retail Trade</option>" +
                "<option value='48-49' title='Establishments  providing transportation of passengers and cargo, warehousing and storage for goods, scenic and sightseeing transportation, and support activities related to modes of transportation'>Transportation & Warehousing</option>" +
                "<option value='51' title='Establishments engaged in producing & distributing information & cultural products, transmit or distribute communications, & processing data'>Information</option>" +
                "<option value='52' title='Establishments primarily engaged in financial transactions and/or in facilitating financial transactions'>Finance and Insurance</option>" +
                "<option value='53' title='Establishments primarily engaged in renting, leasing, or selling tangible or intangible assets, and establishments providing related services'>Real Estate</option>" +
                "<option value='54' title='Establishments that specialize in performing professional, scientific, and technical activities for others'>Professional & Business Services</option>" +
                "<option value='55' title='Establishments in the private sector that administer, oversee, and manage establishments of the company or enterprise'>Management of Companies</option>" +
